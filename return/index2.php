...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-check-double"></i> Approval Pengembalian Asset
        </h1>
        <div class="total-badge">
            <i class="fas fa-boxes"></i> Total Request: <span id="total-requests">0</span>
        </div>
    </div>
    ...
    <form method="POST" action="proses2.php" id="approveForm">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button type="submit" name="setujui" class="btn btn-success btn-sm mr-2">
