                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)):
                            ...
                            // Buat form cetak per baris
                            $print_form_id = 'printForm_' . $row['primary_id'];
                        ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="tools-group">
                                    <a href="../primary/detail.php?id=<?= $row['primary_id'] ?>" class="btn btn-sm btn-info" title="Lihat Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <form method="POST" action="print_return.php" target="_blank" style="display: inline-block;" id="<?= $print_form_id ?>">
                                        <input type="hidden" name="primary_ids[]" value="<?= $row['primary_id'] ?>">
                                        <input type="hidden" name="cetak_satuan" value="1">
                                        <button type="submit" class="btn btn-sm btn-success" title="Cetak BA">
...
$(document).ready(function() {
    ...
    // Tombol Kembalikan Assets (Massal)
