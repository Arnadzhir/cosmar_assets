...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-arrow-circle-left"></i> Pengajuan Pengembalian Asset
        </h1>
    ...
    <form method="POST" action="proses.php" id="returnForm">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-list"></i> Daftar Asset Aktif
                </h6>
                <button type="submit" name="ajukan_return" class="btn btn-warning btn-sm">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            $query = "
                                ...
                                WHERE (p.return_status = 0 OR p.return_status IS NULL)
                                AND p.kondisi_id IS NOT NULL
                            ";
                            ...
                            if (isset($_GET['kategori_id']) && !empty($_GET['kategori_id'])) {
                                ...
                                $query .= " AND EXISTS (SELECT 1 FROM tbl_assets a2 WHERE a2.assets_id = p.assets_id AND a2.kategori_id = '$kategori_id')";
                            }
...
$(document).ready(function() {
    ...
    // Dapatkan instance DataTable yang sudah ada di footer
    var table = $('#dataTable').DataTable();
    
    // Update total assets
    $('#total-assets').text(table.rows().count());
    ...
    // SYNC CHECKBOX - update status checkall
