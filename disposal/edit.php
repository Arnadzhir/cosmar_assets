...
// Ambil ID dari URL
$primary_id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
...
// Ambil data asset yang diajukan disposal
$query = "SELECT 
            p.primary_id,
            p.primary_qty,
            p.disposal_reason,
          ...
          WHERE p.primary_id = $primary_id AND p.disposal_status = 1";
...
$primary_qty = isset($data['primary_qty']) ? $data['primary_qty'] : 0;
...
$lokasi_name = isset($data['lokasi_name']) ? $data['lokasi_name'] : '-';
$lokasi_lantai = isset($data['lokasi_lantai']) ? $data['lokasi_lantai'] : '';

// Format lokasi
$lokasi = $lokasi_name;
if (!empty($lokasi_lantai)) {
    $lokasi .= ' (Lt.' . $lokasi_lantai . ')';
}
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit"></i> Edit Pengajuan Disposal Asset
        </h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <form action="proses.php" method="POST" id="disposalForm">
                ...
                <input type="hidden" name="id" value="<?= $primary_id ?>">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control readonly-field" 
                                   value="<?= number_format($primary_qty) ?> unit" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <!-- Alasan Disposal (Bisa diedit oleh user) -->
                <div class="row mt-3">
                    <div class="col-md-12">
    ...
    $('#disposalForm').on('submit', function(e) {
        ...
        if (approveStatus == 'approve') {
            Swal.fire({
                ...
                text: "Asset akan dihapus dari sistem. Tindakan ini tidak dapat dibatalkan!",
                icon: 'warning',
            ...
            Swal.fire({
                ...
                text: "Pengajuan disposal akan dibatalkan dan asset akan tetap tersedia.",
                icon: 'question',
                showCancelButton: true,
