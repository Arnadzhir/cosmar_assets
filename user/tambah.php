...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-user-plus"></i> Tambah User Akses
        </h1>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                ...
                                required>
                            <small class="text-muted">ID unik untuk login user (sesuai dengan ID karyawan)</small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="text-muted">Minimal 8 karakter (default: user12345)</small>
                        </div>
                    </div>
                </div>
