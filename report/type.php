...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-th-list"></i> Laporan Type Asset
        </h1>
    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="type.php" class="btn btn-reset">
    ...
    <!-- CARD 2: DAFTAR ASSETS BERDASARKAN TYPE -->
        ...
        <div class="card-body">
            ...
            if ($show_data) {
                ...
                $query = "
                    ...
                    INNER JOIN tbl_type t ON a.type_id = t.type_id
                ...
                $filter_nama = '';
                if (isset($_GET['type_id']) && !empty($_GET['type_id'])) {
                    $filter_type = mysqli_real_escape_string($conn, $_GET['type_id']);
                    $query .= " AND t.type_id = '$filter_type'";
                    
                    $qNamaType = mysqli_query($conn, "SELECT type_name FROM tbl_type WHERE type_id = '$filter_type'");
                    $namaType = mysqli_fetch_assoc($qNamaType);
                    $filter_nama = $namaType['type_name'] ?? '';
                }
                ...
                $query .= " ORDER BY t.type_name ASC, a.assets_name ASC, p.primary_id ASC";
                ...
                <div class="info-header">
                    <div class="filter-info">
                        <?php if (isset($_GET['type_id']) && !empty($_GET['type_id'])): ?>
                            <i class="fas fa-filter"></i> Menampilkan asset dengan type: <strong><?= htmlspecialchars($filter_nama) ?></strong>
                        <?php else: ?>
                        ...
                        <table class="table table-bordered" id="dataTable">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($qAssets)): 
                                    ...
                                    if (!isset($_GET['type_id']) && $current_type != $row['type_name']) {
                                        if ($current_type != '') {
                                            ?>
                                            <tr class="total-row">
                                                <td colspan="12" class="font-weight-bold text-right pr-4">
                                                    Total <?= $current_type ?>: <?= $type_total ?> unit
                                                 </div>
                                              </div>
                                            <?php
                                        }
                                ...
                                <tr>
                                    ...
                                    <td><?= $asset_name ?> </div>
                                    <td><strong><?= htmlspecialchars($row['type_name']) ?></strong> </div>
                                ...
                                <?php if (!isset($_GET['type_id']) && $current_type != ''): ?>
                                <tr class="total-row">
                                    <td colspan="12" class="font-weight-bold text-right pr-4">
                                        Total <?= $current_type ?>: <?= $type_total ?> unit
                                     </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Tidak ada asset yang ditemukan untuk type yang dipilih.</p>
                    </div>
                <?php endif; ?>
            ...
            ?>
                <div class="empty-state">
                    ...
                    <p>Silakan pilih type terlebih dahulu.</p>
                </div>
            <?php } ?>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    <?php if (isset($_GET['type_id']) && !empty($_GET['type_id'])): ?>
    $('#type_id').val('<?= $_GET['type_id'] ?>').trigger('change');
    <?php endif; ?>
});
</script>
