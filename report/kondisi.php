...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-clipboard-check"></i> Laporan Kondisi Asset
        </h1>
    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Kondisi</label>
                            <select name="kondisi_id" id="kondisi_id" class="form-control select2">
                                ...
                                while ($kondisi = mysqli_fetch_assoc($qKondisi)) {
                                    echo "<option value='{$kondisi['kondisi_id']}'>{$kondisi['kondisi_name']}</option>";
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="kondisi.php" class="btn btn-reset">
    ...
    <!-- CARD 2: DAFTAR ASSETS BERDASARKAN KONDISI -->
        ...
        <div class="card-body">
            ...
            if ($show_data) {
                ...
                $query = "
                    ...
                    INNER JOIN tbl_kondisi kond ON p.kondisi_id = kond.kondisi_id
                ...
                $filter_nama = '';
                if (isset($_GET['kondisi_id']) && !empty($_GET['kondisi_id'])) {
                    $filter_kondisi = mysqli_real_escape_string($conn, $_GET['kondisi_id']);
                    $query .= " AND kond.kondisi_id = '$filter_kondisi'";
                    
                    $qNamaKondisi = mysqli_query($conn, "SELECT kondisi_name FROM tbl_kondisi WHERE kondisi_id = '$filter_kondisi'");
                    $namaKondisi = mysqli_fetch_assoc($qNamaKondisi);
                    $filter_nama = $namaKondisi['kondisi_name'] ?? '';
                }
                ...
                $query .= " ORDER BY kond.kondisi_name ASC, a.assets_name ASC, p.primary_id ASC";
                ...
                <div class="info-header">
                    <div class="filter-info">
                        <?php if (isset($_GET['kondisi_id']) && !empty($_GET['kondisi_id'])): ?>
                            <i class="fas fa-filter"></i> Menampilkan asset dengan kondisi: <strong><?= htmlspecialchars($filter_nama) ?></strong>
                        <?php else: ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <?php if (!isset($_GET['kondisi_id']) && $current_kondisi != ''): ?>
                                <tr class="total-row">
                                    <td colspan="12" class="font-weight-bold text-right pr-4">
                                        Total <?= $current_kondisi ?>: <?= $kondisi_total ?> unit
                                     </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Tidak ada asset yang ditemukan untuk kondisi yang dipilih.</p>
                    </div>
                <?php endif; ?>
            ...
            ?>
                <div class="empty-state">
                    ...
                    <p>Silakan pilih kondisi terlebih dahulu.</p>
                </div>
            <?php } ?>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    <?php if (isset($_GET['kondisi_id']) && !empty($_GET['kondisi_id'])): ?>
    $('#kondisi_id').val('<?= $_GET['kondisi_id'] ?>').trigger('change');
    <?php endif; ?>
});
</script>
