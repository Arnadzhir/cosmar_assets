...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-clipboard-list"></i> Completed Audit Assets
        </h1>
    ...
    <div class="mb-3 text-right">
        <a href="index.php" class="btn btn-secondary btn-sm">
            <i class="fas fa-arrow-left"></i> Kembali ke Outstanding Audit
        </a>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-list"></i> Daftar Completed Audit Asset
            </h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $selisih_text = ($selisih > 0 ? '+' : '') . number_format($selisih_abs);
                            ...
                            // Tools (Hanya tombol hapus)
                            $tools = '<div class="d-flex justify-content-center" style="gap:5px;">';
                            $tools .= '<a href="proses2.php?hapus=1&id=' . $row['audit_id'] . '" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm(\'Hapus data ini?\')"><i class="fas fa-trash"></i></a>';
                            $tools .= '</div>';
                        ?>
                        <tr>
                        ...
                        <tr>
                            <td colspan="12" class="text-center text-muted py-5">
                                ...
                                <p class="mb-0">Belum ada completed audit data</p>
                                <small>Audit yang sudah selesai akan muncul di sini</small>
                            </div>
                        </tr>
                        <?php endif; ?>
                    </tbody>
